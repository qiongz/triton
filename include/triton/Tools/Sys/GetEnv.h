...
inline const std::set<std::string> CACHE_INVALIDATING_ENV_VARS = {
    ...
    "TRITON_DUMP_MIR",
    "TRITON_AMD_MEMBAR_SKIP_ASYNC_ASYNC",
    "TRITON_ENABLE_AMDGCN_AS",
    "TRITON_ENABLE_AMDGPU_RA_HINTS",
    "TRITON_ENABLE_ATTN_SCHED",
    "TRITON_ATTN_SCHED_NOMISCHED",
    "TRITON_ATTN_SCHED_MODE",
    "TRITON_ENABLE_ATTN_BWD_SCHED",
    "TRITON_ATTN_BWD_NOMISCHED",
    "TRITON_ATTN_BWD_MODE",
    "TRITON_ENABLE_ATTN_FWD_SCHED",
    "TRITON_ATTN_FWD_NOMISCHED",
    "TRITON_ATTN_FWD_MODE",
    "TRITON_ENABLE_PACK_FOPS",
